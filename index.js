...
// ==========================================
const TOKEN_RAW_URL =
  "https://raw.githubusercontent.com/theo-star227/databaseXflower/main/token.json";
...
// ==========================================
// VALIDASI TOKEN DARI GITHUB RAW
// ==========================================
async function validateToken() {
  try {
    ...
    if (!BOT_TOKEN) {
      console.log(chalk.red("❌ BOT_TOKEN tidak ditemukan"));
      return false;
    }

    if (!tokens.includes(BOT_TOKEN)) {
      console.log(chalk.red("❌ Token tidak terdaftar di GitHub Raw"));
      return false;
    }
    ...
    console.error(chalk.red("❌ Validasi token gagal:"), err.message);
    return false;
  }
}
...
𝚇-𝙵𝚕𝚘𝚠𝚎𝚛 ʜᴀs ᴀʀʀɪᴠᴇᴅ. ᴇᴠᴇʀʏᴏɴᴇ, ᴋɴᴇᴇʟ ʙᴇғᴏʀᴇ ʜɪᴍ ɪᴍᴍᴇᴅɪᴀᴛᴇʟʏ.
━━━━━━━━━━━━━━━━━━━━━━
